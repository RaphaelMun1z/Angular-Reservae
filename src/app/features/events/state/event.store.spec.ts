...
class FakeEventApi implements EventApi {
  ...
  addSector(_eventId: string, _request: EventSectorMutationRequest): Observable<unknown> { return of(null); }
  removeSector(_eventId: string, _sectorId: string): Observable<unknown> { return of(null); }
}
